...
- **Grounded crewmates** - per-repo ground truth kept in `data/repos/<key>.md` is injected into every scaffolded brief, so workers start from a repo's real architecture and studied tool choices instead of re-improvising them.
